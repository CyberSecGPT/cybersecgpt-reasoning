...
REQUIRED_FILES = frozenset(
    {
        ...
        "src/cybersecgpt/reasoning/budget.py",
        "src/cybersecgpt/reasoning/candidates.py",
        "src/cybersecgpt/reasoning/errors.py",
        "src/cybersecgpt/reasoning/fallback.py",
        ...
        "src/cybersecgpt/reasoning/termination.py",
        "src/cybersecgpt/reasoning/verification.py",
        "tests/__init__.py",
