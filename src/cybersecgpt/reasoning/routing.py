...
class RoutingDecisionReasonCode(str, Enum):
...
class RoutingDecisionInvalidReason(str, Enum):
...
class RoutingDecision:
    ...
    def __post_init__(self) -> None:
        ...
        if len(set(self.selected_substrates)) != len(self.selected_substrates):
            raise RoutingDecisionError("selected_substrates must not contain duplicates")
